...
const PILLARS = [
  {
    title: "Science-Led",
    body: "Founded by a neuroscientist whose work has advanced the understanding of neurological disorders and cancer mechanisms, our organization is grounded in scientific rigor, innovation, and evidence-based decision-making.",
